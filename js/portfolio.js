...
export async function loadReturns(memberKey, startDate = null) {
  ...
  const multiData = await fetchMultiClose(tickers, startDate || BASE_DATE);
  const traces = [];
...
export async function runRiskAnalysis(selectedNames, investmentMW, confLevel, startDate = null) {
...
export async function runPortfolioOptimization(selectedNames, rfRate, nSim, startDate = null) {
